                  ...
                  <v-flex>
                    <v-card-title primary-title>
                      <div class="text--black">
                        <div><h3 style="font-family:MV Boli;color:#D81B60;font-size:30px" mp-0> {{ item.Faculty}} </h3></div>
                        <div style="font-size:20px"> {{ item.Faculty_Qualification }}</div><br>
                      </div> </v-card-title>
                     <v-card-actions>
    ...
    methods:{
      deleted(_id) {
        ...
        if (jwt) {
          ...
          Axios.delete('http://localhost:3000/Admin/removefaculty/' + _id, {
            headers: {
